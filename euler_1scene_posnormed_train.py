...
def main():
        ...
        if (epoch + 1) % args.val_interval == 0 or epoch == args.epochs - 1:
            ...
            if val_loss < best_val_loss:
                ...
                print(
                    ...
                    f"Pos: {best_val_pos:.6f}, Euler: {best_val_euler:.6f})"
                )
    ...
    print(
        ...
        f"(Epoch: {best_epoch}, Pos: {best_val_pos:.6f}, Euler: {best_val_euler:.6f})"
    )
